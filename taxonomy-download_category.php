  ...
  <div class="row">
    ...
    <div class="col-xxl-8 col-xl-8 col-lg-9 col-md-9 order-0 ps-4">
      <header class="cat_header">
        <h3>محصولات دسته :‌ <?php echo single_cat_title(); ?></h3>
              ...
              <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 order-2 order-sm-1 m-0 my-sm-2">
                <div class="latestPosts2__right">
                      ...
                      <li>
                        ...
                        <div class="meta_title">
                          ...
                          foreach ($categories as $category) { ?>
                            <a href="<?php echo get_category_link($category); ?>"><?= $category->name; ?> </a>
                          <?php } ?>
                        </div>
                      </li>
                  ...
                  <div class="latestPosts2__download">
                    ...
                    <div></div>
                    <a class="latestPosts2__download--link" href="<?php the_permalink(); ?>">خرید و دانلود <i class="bi bi-download"></i></a>
                  </div>
                </div>
              </div>
            </div>
